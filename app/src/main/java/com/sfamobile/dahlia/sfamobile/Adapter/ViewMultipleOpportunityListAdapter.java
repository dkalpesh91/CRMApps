 ...
 */
public class ViewMultipleOpportunityListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ViewMultipleOpportunityListAdapter(Activity a, String[] d) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            holder.cid.setText("Opportunity Id -"+idStr[position]);
    ...
    private class OnItemClickListener  implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            Intent intent = new Intent(activity,OpportunityEditActivity.class);
