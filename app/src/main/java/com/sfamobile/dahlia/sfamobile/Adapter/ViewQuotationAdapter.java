 ...
 */
public class ViewQuotationAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ViewQuotationAdapter(Activity a, ArrayList<ProductCatalogModel> d) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.quatation_product_catalog, null);
