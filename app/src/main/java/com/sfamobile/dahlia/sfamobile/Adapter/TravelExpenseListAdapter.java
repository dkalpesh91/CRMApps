...
import com.sfamobile.dahlia.sfamobile.Activity.TravelExpenseShowActivity;
 ...
 */
public class TravelExpenseListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public TravelExpenseListAdapter(Activity a, String[] d) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.travel_expense_list, null);
...
//        }
    ...
    private class OnItemClickListener  implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            Intent intent = new Intent(activity,TravelExpenseShowActivity.class);
